...
public class TestFileDePrioriteImpl {
	...
	private static void testMax() {
		...
		if(!pTrouve.prenom.equals("anouk")){
	...
	private static void testInsere() {
		...
		file.insere(zoe);
		if(!file.toString().equals("[  [ anouk (8) ] lea (5) [ zoe (2) ]  ]")){
			System.out.println("\nAttention, apres ajout de zoe, la file de priorite obtenue :");
			System.out.println(file.toString());
			System.out.println("Elle devrait etre :");
			System.out.println("[  [ anouk (8) ] lea (5) [ zoe (2) ]  ]");
			System.out.println();
			System.out.println("Revoyez votre methode !");
			return;
		}
		...
		file.insere(sam);
		if(!file.toString().equals("[  [ anouk (8) ] lea (5) [  [ sam (3) ] zoe (2) [ ]  ]  ]")){
			System.out.println("\nAttention, apres ajout de sam, la file de priorite obtenue :");
			System.out.println(file.toString());
			System.out.println("Elle devrait etre :");
			System.out.println("[  [ anouk (8) ] lea (5) [  [ sam (3) ] zoe (2) [ ]  ]  ]");
			System.out.println();
			System.out.println("Revoyez votre methode !");
			return;
		}
		...
		file.insere(hugo);
		if(!file.toString().equals("[  [  [ ] anouk (8) [ hugo (6) ]  ] lea (5) [  [ sam (3) ] zoe (2) [ ]  ]  ]")){
			System.out.println("\nAttention, apres ajout de hugo, la file de priorite obtenue :");
			System.out.println(file.toString());
			System.out.println("Elle devrait etre :");
			System.out.println("[  [  [ ] anouk (8) [ hugo (6) ]  ] lea (5) [  [ sam (3) ] zoe (2) [ ]  ]  ]");
			System.out.println();
			System.out.println("Revoyez votre methode !");
			return;
		}
		...
		file.insere(tim);
		if(!file.toString().equals("[  [  [ ] anouk (8) [ hugo (6) ]  ] lea (5) [  [  [ ] sam (3) [ tim (3) ]  ] zoe (2) [ ]  ]  ]")){
			System.out.println("\nAttention, apres ajout de tim, la file de priorite obtenue :");
			System.out.println(file.toString());
			System.out.println("Elle devrait etre :");
			System.out.println("[  [  [ ] anouk (8) [ hugo (6) ]  ] lea (5) [  [  [ ] sam (3) [ tim (3) ]  ] zoe (2) [ ]  ]  ]");
			System.out.println();
			System.out.println("Revoyez votre methode !");
			return;
		}
		...
		file.insere(marie);
		if(!file.toString().equals("[  [  [ ] anouk (8) [ hugo (6) ]  ] lea (5) [  [  [ marie (5) ] sam (3) [ tim (3) ]  ] zoe (2) [ ]  ]  ]")){
			System.out.println("\nAttention, apres ajout de marie, la file de priorite obtenue :");
			System.out.println(file.toString());
			System.out.println("Elle devrait etre :");
			System.out.println("[  [  [ ] anouk (8) [ hugo (6) ]  ] lea (5) [  [  [ marie (5) ] sam (3) [ tim (3) ]  ] zoe (2) [ ]  ]  ]");
			System.out.println();
			System.out.println("Revoyez votre methode !");
			return;
		}
	...
	private static void testIterateur() {
		...
		file = enonce();
		String[] attendu = {"anouk", "hugo", "lea", "marie", "sam", "tim", "zoe"};
		int i = 0;
