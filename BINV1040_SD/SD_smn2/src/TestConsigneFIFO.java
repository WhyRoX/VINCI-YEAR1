...
public class TestConsigneFIFO{
	...
	public static void main(String[] args) {
		...
		ConsigneFIFO consigne = new ConsigneFIFO(3);
		...
		// Le constructeur a-t-il bien rempli la file?
		...
		// Apres ces 3 liberations , la file : tete 2 0 1 queue
		...
		// la file : tete 2 0 1 queue
		// test10 - test11 - test12
		// attribution de 3 casiers
		// on verifie si les attributions des 3 casiers suivent l'ordre 2 puis 0 puis 1

		System.out.println("test 10 : attribution casier avec le mot de passe 'mdp2'");
		try {
			numero = consigne.attribuerCasierLibre(String.valueOf("mdp2"));
			if (numero != 2) {
				System.out.println("test 10 ko : numero attendu = 2, numero recu : "+numero);
				System.out.println("Avez-vous toujours bien rempli la file (FIFO) et uniquement dans le cas ou la liberation est effective?");
				System.exit(0);
			}
		} catch (Exception e) {
		...
		try {
			...
			if (numero != 0) {
				...
				System.out.println("Avez-vous toujours bien rempli la file et uniquement dans le cas ou la liberation est effective?");
				System.exit(0);
			}
		} catch (Exception e) {
		...
		System.out.println("test 12 : attribution casier avec le mot de passe 'mdp1'");
		try {
			numero = consigne.attribuerCasierLibre(String.valueOf("mdp1"));
			if (numero != 1) {
				System.out.println("test 12 ko : numero attendu = 1, numero recu : "+numero);
				System.out.println("Avez-vous toujours bien rempli la file et uniquement dans le cas ou la liberation est effective?");
				System.exit(0);
			}
		} catch (Exception e) {
