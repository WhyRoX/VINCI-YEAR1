public class NoirJauneRougeSwitch {
    ...
    public NoirJauneRougeSwitch(Ecolier[] tableARecopier, int nombreNoirs, int nombreJaunes, int nombreRouges) {
        this.tableTriee = new Ecolier[NOMBRE_MAX_ECOLIERS];
