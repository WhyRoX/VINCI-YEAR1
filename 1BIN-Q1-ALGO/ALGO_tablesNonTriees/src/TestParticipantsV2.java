...
public class TestParticipantsV2 {
    ...
    public static void main(String[] args) {
        ...
        int choix;
        System.out.println("**********************************************");
        System.out.println("Programme Test pour la classe ParticipantsV2 :");
        System.out.println("**********************************************");
        System.out.println();
        do {
    ...
    private static void contient() {
        ...
        try {
            ...
            ParticipantsV2 p = new ParticipantsV2(nombreMaxParticipants, t);
