...
public class NombreMystereInverse {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Entrez le nombre à deviner entre 0 et 100 : ");
        ...
        do {
            ...
            essais++;
            System.out.println("Est-ce que le nombre à deviner est " + proposition + " ? (+, -, =)");
        ...
        if (reponse == '=') {
            ...
            System.out.println("L'ordinateur n'a pas réussi à deviner le nombre. Le nombre à deviner était : " + nombreADeviner);
        }
    }
}
